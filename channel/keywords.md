# Ключевые слова (обновлено: июнь 2026)
...
deception history, propaganda history, industrial espionage, information warfare,
disinformation, psychological warfare, dark history, spy documentary,
espionage, declassified, intelligence, spy history, true spy story,
secret history, espionage documentary, covert operations history

## Теги-паки по типу эпизода

**«Операция»:**
covert operation, secret operation, CIA operation, regime change,
coup, black ops, tradecraft, spycraft, intelligence operation

**«Ложь» (пропаганда/дезинформация):**
propaganda, disinformation, active measures, psychological warfare,
influence operation, information warfare, fake news history,
media manipulation, state propaganda, psyop

**«Кража» (технологический/экономический шпионаж):**
industrial espionage, corporate espionage, stolen technology,
economic espionage, patent theft, spy ring, scientific espionage,
trade secrets, technology theft

**«Предательство»:**
mole, insider threat, double agent, defector, spy ring, betrayal

**«Мелкая сошка»:**
ordinary people history, unsung heroes spy, butterfly effect history,
small player big impact, forgotten spy, anonymous intelligence

**«Патентные / корпоративные войны»:**
patent war, corporate espionage, technology race, trade war secrets,
invention theft, business intelligence, competitive intelligence

**«Информационные войны»:**
information war, perception management, propaganda techniques,
media control, narrative control, fake news history, influence campaign
...
| Ключ | Объём/мес | Конкуренция | Примечание |
|------|-----------|-------------|------------|
| ⭐ disinformation | ~31 000 | 46 | 100% США |
...
Сами по себе теги на YouTube играют малую роль. Основную выдачу решают заголовок, обложка и первые строки описания.

- Главный ключ — в **заголовок** и в **первую строку описания**
- Теги — страховка для алгоритма, не двигатель
